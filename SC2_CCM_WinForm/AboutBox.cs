...
namespace SC2_CCM_WinForm
{
    partial class AboutBox : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = String.Format("About {0}", Consts.AppName);
            this.labelProductName.Text = Consts.AppName;
            this.labelVersion.Text = String.Format("Version {0}", Consts.Version);
            this.labelCopyright.Text = "Copyright 2022. MIT License";
            this.labelCompanyName.Text = "Matt Tolman";
